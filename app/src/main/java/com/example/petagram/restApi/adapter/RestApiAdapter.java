...
import com.example.petagram.restApi.deserializador.ContactoDeserializador;
...
public class RestApiAdapter {
    ...
    public Gson construyeGsonDeserializadorMediaRecent(){
        ...
        gsonBuilder.registerTypeAdapter(AnimalResponse.class, new ContactoDeserializador());
